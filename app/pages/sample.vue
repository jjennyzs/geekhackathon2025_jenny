<script setup lang="ts">
    ...
    const initializeFlow = () => {
      ...
      edges.value = [
        { id: "e-main-1", source: "main", target: "1", type: "smoothstep", animated: true },
        { id: "e-main-2", source: "main", target: "2", type: "smoothstep", animated: true },
        { id: "e-main-3", source: "main", target: "3", type: "smoothstep", animated: true },
        { id: "e-main-4", source: "main", target: "4", type: "smoothstep", animated: true },
        { id: "e-main-5", source: "main", target: "5", type: "smoothstep", animated: true },
        { id: "e-3-3-1", source: "3", target: "3-1", type: "smoothstep", animated: true },
        { id: "e-3-3-2", source: "3", target: "3-2", type: "smoothstep", animated: true },
        { id: "e-3-3-3", source: "3", target: "3-3", type: "smoothstep", animated: true },
        { id: "e-3-3-4", source: "3", target: "3-4", type: "smoothstep", animated: true },
      ];
    };
    ...
    const startEdit = (nodeId: string) => {
      ...
      nextTick(() => {
        const input = document.getElementById(`input-${nodeId}`) as HTMLInputElement | null;
        if (input) {
          input.focus();
          input.select();
        }
    ...
    <template>
      <main class="min-h-screen bg-gray-50">
        <div class="p-8">
          ...
          <ClientOnly>
            <div class="h-[calc(100vh-200px)] w-full border border-gray-300 rounded-lg overflow-hidden">
              <VueFlow
                :nodes="nodes"
                :edges="edges"
                ...
                <template #node-custom="nodeProps">
                  ...
                  >
                    ...
                    <div v-else class="node-content">
                      <div
                        class="node-label"
                        :style="{ color: (nodeProps.data as any).isMain ? 'white' : 'inherit' }"
                      >
                      ...
                      <div class="node-actions">
                        ...
                        <button
                          ...
                          @click.stop="deleteNode(nodeProps.id, (nodeProps.data as any).isMain)"
